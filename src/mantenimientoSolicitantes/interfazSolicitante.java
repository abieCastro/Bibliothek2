...
public class interfazSolicitante {
    ...
    JButton btRegistrarD, btLimpiarA, btLimpiarD;
...
//            jpRegA.setBackground(Color.LIGHT_GRAY);
        ...
        btLimpiarA = new JButton("Limpiar");
        btLimpiarA.setBounds(200, 300, 100, 20);
        btLimpiarA.setVisible(true);
        jpRegA.add(btLimpiarA);

        btLimpiarA.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
...
//            jpRegD.setBackground(Color.LIGHT_GRAY);
        ...
        btLimpiarD = new JButton("Limpiar");
        btLimpiarD.setBounds(200, 120, 100, 20);
        btLimpiarD.setVisible(true);
        jpRegD.add(btLimpiarD);

        btLimpiarD.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
...
//            jpBusqD.setBackground(Color.LIGHT_GRAY);
    ...
    public void btLimpiarA(ActionEvent evt) {
    ...
    public void btLimpiarD(ActionEvent evt) {
        txtControlD.setText("");
        txtNombreD.setText("");
        txtPaternoD.setText("");
        txtMaternoD.setText("");
